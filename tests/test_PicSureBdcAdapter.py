...
class TestBdcAdapter(unittest.TestCase):
    ...
    def test_Query_consents_minimal(self, MockPicSureConnection):
        ...
        self.assertNotIn(
            "\\_harmonized_consent\\", filtered_query["query"]["categoryFilters"]
        )
        self.assertNotIn(
            "\\_topmed_consents\\", filtered_query["query"]["categoryFilters"]
        )
    ...
    def test_Query_consents_w_harmonized(self, MockPicSureConnection):
        ...
        query = Query(conn, load_query=queryTemplate)
        query._lstFilter.data[harmonized_path] = {
            "HpdsDataType": "nothing",
            "type": "minmax",
        }
    ...
    def test_Query_consents_w_topmed(self, MockPicSureConnection):
        ...
        query = Query(conn, load_query=queryTemplate)
        query._lstFilter.data["genomic_info"] = {
            "HpdsDataType": "info",
            "type": "categorical",
            "values": ["CHD8"],
        }
    ...
    def test_Query_consents_list(self, MockPicSureConnection):
        ...
        self.assertEqual(
            len(consent_df),
            88,
            "expecting to have 88 records in the consents dataframe",
        )
